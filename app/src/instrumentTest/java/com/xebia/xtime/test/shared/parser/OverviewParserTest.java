package com.xebia.xtime.test.shared.parser;
...
public class OverviewParserTest extends TestCase {
    ...
    private static final String INPUT_REGULAR = "throw 'allowScriptTagRemoting is false.';\n" +
            ...
            "s10={};var s11={};var s12={};var s13={};var s1=[];var s14={};var s15={};var s16=[];" +
            "var s17={};var s18={};var s19={};var s20=[];var s21={};var s2=[];s0[0]=s3;s0[1]=s4;" +
            "s0[2]=s5;s0[3]=s6;s0[4]=s7;s0[5]=s8;s0[6]=s9;s0[7]=s10;s0[8]=s11;s0[9]=s12;" +
            "s0[10]=s13;\n" +
            ...
            ".hour=\"8.0\";s17.transferredToAfas=false;\n" +
            "s18.approved=true;s18.entryDate=new Date(1388444400000);s18.fromAfas=true;s18" +
            ".hour=\"8.0\";s18.transferredToAfas=false;\n" +
            "s19.approved=false;s19.entryDate=new Date(1388530800000);s19.fromAfas=false;s19" +
            ".hour=\"8.0\";s19.transferredToAfas=false;\n" +
            "s15.clientName=\"CLIENT X\";s15.description=\"\";s15.projectId=\"0001\";s15" +
            ".projectName=\"PROJECT 1\";s15.timeCells=s20;s15.userId=\"1015900\";s15" +
            ".workTypeDescription=\"Work work work\";s15.workTypeId=\"400\";\n" +
            "s20[0]=s21;\n" +
            "s21.approved=false;s21.entryDate=new Date(1388617200000);s21.fromAfas=false;s21" +
            ".hour=\"7.0\";s21.transferredToAfas=false;\n" +
            "s2[0]=4;s2[1]=5;\n" +
            "dwr.engine._remoteHandleCallback('0','0',{lastTransferredDate:new Date" +
            "(1388444400000),monthDaysCount:7,monthlyDataApproved:true," +
